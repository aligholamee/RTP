...
\documentclass[margin, 10pt]{res} % Use the res.cls style, the font size can be changed to 11pt or 12pt here
	...
	\moveleft0.7\hoffset\centerline{\url{https://aligholamee.github.io}}
 	...
 	\moveleft0.7\hoffset\centerline{\tiny\textsc{\underline{Updated on July 4, 2018}}}
    %----------------------------------------------------------------------------------------
    ...
    \textbf{B.S. Computer Engineering} \textsc{@}
	   ...
	   {\UrlFont[ 1'st Industrial University in Iran ]}\hfill {\UrlFont{\underline{GPA: 3.6/4}}}\\
...
\end{innerlist}
	...
	\textbf{Machine Learning Lab} \textsc{@} \textsc{Amirkabir University of Technology}
	\hfill {July 2018 -- Present}\\
	\textit{Computer Vision | Pattern Recognition}
	\vspace{0.15cm}
	\begin{innerlist}
		\item Generative Adversarial Models for Style Transfer in Images
		\item Analysis of Formal Representation of Deep Learning Models
