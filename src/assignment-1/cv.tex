...
\documentclass[margin, 10pt]{res} % Use the res.cls style, the font size can be changed to 11pt or 12pt here
	...
	\moveleft.5\hoffset\centerline{\url{ceit.aut.ac.ir/~aligholamee}}
 	...
 	\vspace{0.1cm}
 	\moveleft.5\hoffset\centerline{\href{https://stackoverflow.com/users/4723938/aligholamee}{\UrlFont\color{black}\small{[\ \faCodeFork}\ ]}\href{https://www.linkedin.com/in/ali-gholami-987136b5/}{\UrlFont\color{black}\small{[\ \faLinkedin}\ ]}\href{github.com/aligholamee}{\UrlFont\color{black}\small{[\ \faGithubAlt}\ ]}}
    %----------------------------------------------------------------------------------------
